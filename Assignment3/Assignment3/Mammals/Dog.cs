...
namespace Assignment3.Mammals
{
    public class Dog : Mammal
    {
        ...
        public Dog(string name, int age, GenderType gender, AnimalCategoryEnum category, string description, int teeth) : base(name, age, gender, category, description, teeth)
        {
            SetFoodSchedule();
        }
        /// <summary>
